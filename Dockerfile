...
LABEL org.opencontainers.image.description="PHP 8.1 FPM environment optimized for Magento 2.4.8"
LABEL org.opencontainers.image.source="https://github.com/basantmandal/Docker_HK2_Magento_PHP8.1"
